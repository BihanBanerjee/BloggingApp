...
function DashProfile() {
    ...
    const uploadImage = async () => {
        ...
        uploadTask.on(
            ...
            (error) => {
                setImageFileUploadError('Could not upload image (File must be less than 2MB and in any image format)');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                setUpdateUserError(data.message); // Though we have global state for this purposes, but still...
            } else {
